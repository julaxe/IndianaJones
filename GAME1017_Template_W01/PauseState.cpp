...
{
	m_pPauseLabel = new Label("title", 400,250,"PAUSE");
	m_pPause = new Sprite({ 0,0,1000,1000 }, { 420,350,3000,3000 }, "Img/pause.png", "pause");
	SDL_SetTextureAlphaMod(TextureManager::GetTexture("pause"), 90);
	m_pResumeButton = new ResumeButton({ 0,272,66,60 }, { 500,400,66,60 }, "Img/buttons_map.png", "resume");
	m_pQuitButton = new QuitButton({ 0,404,66,60 }, { 700,400,66,60 }, "Img/buttons_map.png", "quit");
	m_pRestartButton = new RestartButton({ 898,336,67,63 }, { 600,400,67,63 }, "Img/buttons_map.png", "quit");
}
